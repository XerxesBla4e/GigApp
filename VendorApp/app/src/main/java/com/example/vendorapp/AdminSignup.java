...
public class AdminSignup extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener, LocationListener, View.OnClickListener {
    private static final int IMG_PICK_CODE = 99;
    private ImageView coordinates;
    public Double longitude, latitude;
    private String address;
    private EditText name, orgbiz, email, phonenumber, pass,addres;
    private EditText specialkey;
    private String sname, semail, skey, sorg, sphonenumber, spass, city, state, country, district;
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            Toast.makeText(AdminSignup.this, "Couldnt get the location", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void hooks() {
        ...
        orgbiz = findViewById(R.id.edttextorg);
        ...
        clientsgnup = findViewById(R.id.jobseeker);
    ...
    private boolean validatefields() {
        ...
        sorg = orgbiz.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(sorg)) {
            orgbiz.setError("Shop Name Field Cant Be Empty");
            orgbiz.requestFocus();
            return false;
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.profile:
                ...
                break;
            case R.id.jobseeker:
                startActivity(new Intent(AdminSignup.this, JSkrSignup.class));
                break;
            case R.id.bk2:
                onBackPressed();
                break;
            ...
            ref.child(mAuth.getUid()).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(AdminSignup.this, getString(R.string.success), Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(AdminSignup.this, Login.class));
                            finish();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(AdminSignup.this, "Failed: Error:" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
