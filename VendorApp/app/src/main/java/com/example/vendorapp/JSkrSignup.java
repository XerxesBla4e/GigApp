...
public class JSkrSignup extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jseeker_register);
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            try {
                Geocoder geocoder = new Geocoder(JSkrSignup.this, Locale.getDefault());
            ...
            Toast.makeText(JSkrSignup.this, "Couldnt get the location", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void hooks() {
      ...
      //  edit = findViewById(R.id.vndrsignup);
        progressDialog = new ProgressDialog(JSkrSignup.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.vndrsignup:
                startActivity(new Intent(JSkrSignup.this, AdminSignup.class));
                break;
            case R.id.bk1:
                onBackPressed();
                break;
    ...
    private void UploadData() {
        ...
        if (choosenimg == null) {
            ...
            hashMap.put("approvedstatus", "pending");
            hashMap.put("currentAmount", "");
            ...
            ref.child(mAuth.getUid()).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            progressDialog.dismiss();
                            Toast.makeText(JSkrSignup.this, getString(R.string.success), Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(JSkrSignup.this, Login.class));
                            finish();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(JSkrSignup.this, "Failed: Error:" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
